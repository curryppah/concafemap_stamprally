  ...
  return (
    <div className="tabbar">
      <ul>
        ...
        <li><Link to="/category"><div className="icon"><FaSearch /></div><div className="text">エリア</div></Link></li>
        <li><Link to="/images"><div className="icon"><FaCamera /></div><div className="text">写真から探す</div></Link></li>
        <li><Link to="/about"><div className="icon"><AiOutlineAppstore /></div><div className="text">アプリについて</div></Link></li>
      </ul>
    </div>
  );
};
